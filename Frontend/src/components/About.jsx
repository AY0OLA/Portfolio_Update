          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4 sm:gap-6 justify-items-center">
            {technologies.map((tech, index) => (
              <div
                key={tech.name}
                data-aos="zoom-in"
                data-aos-delay={700 + index * 80}
                className="w-full sm:w-auto"
              >
                <div
                  className={`flex items-center gap-3 px-4 py-2 sm:px-6 sm:py-3 rounded-lg border font-medium transition-transform duration-200 transform hover:scale-105 hover:shadow-lg text-sm sm:text-base ${tech.color}`}
                  role="listitem"
